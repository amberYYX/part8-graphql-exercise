...
const resolvers = {
  Query: {
    bookCount: (root, args) => {
      ...
      const sameAuthor = books.filter(book => book.author === args.author)
      return sameAuthor.length
    },
    authorCount: () => authors.length,
    allBooks: (root, args) => {
      if (args.author && args.genre) {
        const aimAuthor = books.filter(book => book.author === args.author)
        const results = aimAuthor.filter(book =>
  ...
  Mutation: {
    addBook: (root, args) => {
      ...
      const author = { name: args.author, id: newId }
    ...
    editAuthor: (root, args) => {
      ...
      const authorEdited = { ...authorToEdit, born: args.setBornTo }
